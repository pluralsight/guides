...
You can use various tools that help with mocking up your application's user interface, but I tend to be old school about it and I made a hand drawing of how I imagined the app should look like:
