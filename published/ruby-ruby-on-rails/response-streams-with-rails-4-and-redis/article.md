...
For an example of how this technique is used, read the post on [Teaching iOS 7 at Code School](https://www.codeschool.com/blog/authors/adam-fortuna/). This post details the user experience that can be achieved using response streams.
