...
### Webpack, React, Babel, and more! by Julia Gao
- [Read the guide](http://tutorials.pluralsight.com/review/webpack-react-babel-and-more)
- [Read more from Julia Gao](http://tutorials.pluralsight.com/user/ryoia) <img src="https://avatars.githubusercontent.com/u/3303020?v=3" width="30" height="30" alt="Julia Gao" />
- Related to: Front-End JavaScript (Angular, React, Meteor, etc)
