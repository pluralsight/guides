...
What this code does is generating a new GUID on every GET call stating the expiration date and the issuer. 
...
I hope I've proven how easy and straight forward scaling can be with Docker Swarm mode. 
